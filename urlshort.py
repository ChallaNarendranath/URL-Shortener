...
def your_url():
    if request.method=="POST":
        ...
        if request.form['code'] in urls.keys():
            flash('This short name has  been already taken for another URL. So please select another short name')        
        ...
        if 'url' in request.form.keys():
            ...
            f.save('C:/Users/naren/Desktop/url-shortener/urlshort/static/user_files' + fullname)
